...
<div id="wrapper">
	<body>
		...
		<div id="div_main">
			<div id="div_content">
				<center>
					<h1 style="font-size:35px">บันทึกวัสดุใหม่สำเร็จ</h1>
					<br>
					<a href="index.php" class="button1">เสร็จสิ้น</a> &nbsp &nbsp &nbsp <a href="add_new.php" class="button1">เพิ่มวัสดุอื่น</a>
				</center>
			</div> <!-- end div_content -->
		</div> <!-- end div_main -->
	</body>
